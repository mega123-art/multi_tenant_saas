...
pub async fn create_project(
    ...
    let project = with_tenant(pool, tenant_id, |tx| {
        async move {
...
pub async fn list_projects(pool: &PgPool, tenant_id: Uuid) -> Result<Vec<Project>, ApiError> {
    let projects = with_tenant(pool, tenant_id, |tx| {
        async move {
